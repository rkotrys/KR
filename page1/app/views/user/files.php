<div id="files_list" uname="<?=$user["uname"]?>" class="container" >
    ...
    <table class="table table-striped table-bordered table-sm">
        ...
        <?php else: ?>
            ...
            <td style="fornt-size:150%;text-align:center;"><a class="fileedit" href="#" fid="<?=$f->fid?>"><span class="fa fa-edit"></span></a> <a class="filedelete" href="#" fid="<?=$f->fid?>"><span class="fa fa-trash"></span></a></td>
            </tr>    
            <?php endforeach ?>
        <?php endif ?>
    </table>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editfileModalLabel"><span class="fa fa-upload"></span> <?=isset($file)?lang("Edit_file"):lang("New_file")?></h5>
