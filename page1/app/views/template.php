...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html">
                <img src="images/logo_KR_blue.png" alt="Katedra Radiokomunikacji - Politechnika Poznańka">
            </a>
        </div>
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <ul class="header-nav__list">
                    ...
                    <li class="current"><a class="smoothscroll"  href="#about" title="Działalność">Działalność</a></li>
                    <li><a class="smoothscroll"  href="#services" title="Osiągnięcia">Wyposażenie</a></li>
                    <li><a class="smoothscroll"  href="#achievements" title="works">Osiągnięcia</a></li>
                    <li><a class="smoothscroll"  href="#clients" title="clients">Pracownicy</a></li>
                    <li><a class="smoothscroll"  href="#didactics" title="didactics">Dydaktyka</a></li>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead subhead--dark">Działalność</h3>
                <h1 class="display-1 display-1--light">Naukowo-Badawcza</h1>
            </div>
        </div> <!-- end section-header -->

        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <h2>Systemy i układy telekomunikacji bezprzewodowej i przewodowej</h2>
                <p>
                ...
                <h2>Sieci bezprzewodowe WLAN</h2>
                <p>
                ...
                <h2>Projektowanie i testowanie scalonych układów cyfrowych wielkiej skali integracji</h2>
                <p>
        ...
        <div class="row about-stats stats block-1-4 block-m-1-2 block-mob-full" data-aos="fade-up">
            ...
            <div class="col-block stats__col ">
                <div class="stats__count">431</div>
                <h5>Publikacji</h5>
            </div>
            <div class="col-block stats__col">
    ...
    <section id='services' class="s-services">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead">Czym dysponujemy</h3>
                <h1 class="display-2">Laboratoria i ich wyposażenie</h1>
            </div>
        </div> <!-- end section-header -->
        ...
        <div class="row services-list block-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">Laboratorium komputerowe</h3>
                    <p>Wyposażone w kilkanaście komputerów PC z układami zewnętrznymi i oprogramowaniem, używane w przedmiotach Laboratorium Podstaw Informatyki (nauka C i C++), Laboratorium Mikroprocesorów oraz Laboratorium Układów Logicznych.
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">Laboratorium procesów sygnałowych</h3>
                    <p>Sieć komputerów PC wykorzystywana w ramach przedmiotu "Układy mikroprocesorowe" z modułami z procesorem 8051 i assemblerem 80×86, a w ramach przedmmmiotu "Cyfrowe przetwarzanie sygnałów" – z pakietam MATLAB. 
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    <h3 class="h2">Laboratorium sieci bezprzewodowych WLAN</h3>
                    <p>Wyposażone w komputery PC, urządzenia sieci bezprzewodowej standardu 802.11 a/b/g/n/ac (sterowniki, analizatory, adapterty, punkty dostepu, mosty itp.) wykorzystywane na zajęciach laboratoryjnych z sieci bezprzewodowych WLAN.
                    </p>
                </div>
            </div>
            <!--
    ...
    <!-- achievements
    ================================================== -->
    <section id='achievements' class="s-achievements">

        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead subhead--dark">Nasze</h3>
                <h1 class="display-1 display-1--light">Osiągnięcia</h1>
            </div>
        </div> <!-- end section-header -->

        <div class="row achievements-desc" data-aos="fade-up">
            <div class="col-full">
                <h2>Projekty i współpraca międzynarodowa</h2>
                
<ul>
<li>Udział w międzynarodowym projekcie badawczym w ramach 5. Programu Ramowego Unii Europejskiej, WIND-FLEX - Wireless Indoor Flexible High Bitrate Modem
</li><li>
...
<h2>Monografie i podręczniki </h2>
<ul>
<li>
    ...
    <section id="clients" class="s-clients">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead">Nasz zespół</h3>
                <h1 class="display-2">Kadra naukowo-dydaktyczna<br >Katedry Radiokomunikacji</h1>
            </div>
        </div> <!-- end section-header -->


        <div class="row staff-list block-1-1 block-tab-full">

           <div class="col-block staff-item" data-aos="fade-up">
                <div class="staff-icon">
                    <img src="images/staff/Bogucka.jpg" />
                </div>
                <div class="staff-text">
                    <h2>Prof. dr hab. inż. Hanna Bogucka</h2>
                    <h3 class="h2">Profesor zwyczajny, Kierownik Katedry Radiokomunikacji</h3>
                    <p>
...
Prof. dr hab. inż. Hanna Bogucka prowadzi też działalność dydaktyczną na Politechnice Poznańskiej zarówno na studiach dziennych, jak i zaocznych. Aktualnie prowadzi wykłady z Systemów Telekomunikacyjnych, Podstaw Radiokomunikacji, Radiokomunikacji oraz Systemów Radia Programowalnego i Kognitywnego.
           ...
           <div class="col-block staff-item" data-aos="fade-up">
                <div class="staff-icon">
                    <img src="images/staff/Wesolowski.jpg" />
                </div>
                <div class="staff-text">
                    <h2>Prof. dr hab. inż. Krzysztof Wesołowski</h2>
                    <h3 class="h2">Profesor zwyczajny, Dziekan Wydziału Elektroniki i Telekomunikacji</h3>
                    <p>
...
Profesor Krzysztof Wesołowski pełnił w latach 2007-2010 funkcję członka Sekcji Nauk Technicznych Centralnej Komisji ds. Stopni i Tytułów Naukowych.
           ...
           <div class="col-block staff-item" data-aos="fade-up">
                <div class="staff-icon">
                    <img src="images/staff/Tyszer.jpg" />
                </div>
                <div class="staff-text">
                    <h2>Prof. dr hab. inż. Jerzy Tyszer</h2>
                    <h3 class="h2">Profesor zwyczajny</h3>
                    <p>
...
Prof. Jerzy Tyszer koordynuje współpracę Wydziału Elektroniki i Telekomunikacji Politechniki Poznańskiej z firmą Mentor Graphics Corporation, Wilsonville, OR, USA. W ramach wspólnych prac badawczo-wdrożeniowych opracowano między innymi nowoczesne technologie testowania układów cyfrowych TestKompres oraz Xpress. Technologie te zdobyły szereg prestiżowych nagród jako najlepszy produkt roku na rynku narzędzi do automatycznego projektowania testowalnych układów cyfrowych. Artykuł prezentujący podstawowe elementy technologii TestKompress został także uznany za najbardziej wpływową pracę roku 2002 w dziedzinie testowania układów cyfrowych.
           ...
           <div class="col-block staff-item" data-aos="fade-up">
                <div class="staff-icon">
                    <img src="images/staff/Szulakiewicz.jpg" />
                </div>
                <div class="staff-text">
                    <h2>dr hab. inż. Paweł Szulakiewicz</h2>
                    <h3 class="h2">prof. nadzw. Politechniki Poznańskiej (od r. ak. 2017/18 na emeryturze)</h3>
                    <p>
...
Dr Paweł Szulakiewicz jest autorem i współautorem ponad 50 publikacji krajowych i zagranicznych, w tym w IEEE Transactions on Communications, Transactions on Information Theory, IEE Electronics Letters oraz na światowych konferencjach telekomunikacyjnych.                     
           ...
           <div class="col-block staff-item" data-aos="fade-up">
                <div class="staff-icon">
                    <img src="images/staff/Krasicki.jpg" />
                </div>
                <div class="staff-text">
                    <h2>dr hab. inż. Maciej Krasicki</h2>
                    <h3 class="h2">Adiunkt</h3>
                    <p>
...
Swoją działalność naukową prowadzi w Katedrze Radiokomunikacji Wydziału Elektroniki i Telekomunikacji. Obecnie obszarem zainteresowania jest warstwa fizyczna bezprzewodowych sieci komputerowych, ze szczególnym uwzględnieniem techniki wieloantenowej, turbokodowania i kodów przestrzenno-czasowych. Maciej Krasicki prowadzi zajęcia laboratoryjne z techniki cyfrowej, zaawansowanych technik transmisyjnych oraz ćwiczenia w zakresie systemów transmisji cyfrowej.                     
        ...
        <div class="row clients-outer" data-aos="fade-up">
            <div class="col-full">
                <div class="clients">
                    ...
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Bogucka.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Wesolowski.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Tyszer.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Szulakiewicz.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Krenz.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Krasicki.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Remlein.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Kliks.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Kotrys.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Sroka.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Langowski.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Cichon.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Sybis.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Lenarska.jpg" /></a>
                    <a href="#0" title="" class="clients__slide"><img src="images/staff/Rodziewicz.jpg" /></a>
                </div> <!-- end clients -->
            </div>  <!-- end col-full -->    
    ...
    <!-- didactics
    ================================================== -->
    <section id='didactics' class="s-didactics">

            <div class="row section-header has-bottom-sep" data-aos="fade-up">
                <div class="col-full">
                    <h3 class="subhead">Dydaktyka</h3>
                    <h1 class="display-2">Dla studentów</h1>
                </div>
            </div> <!-- end section-header -->
    
            <div class="row didactics-list block-1-2 block-tab-full">
    
                <div class="col-block didactics-item" data-aos="fade-up">
                    <a href="#">
                    <div class="didactics-pannel">
                    <div class="didactics-icon">
                        <img src="images/staff/Bogucka.jpg" />
                    </div>
                    <div class="didactics-text">
                        
                        <h3>Prof. dr hab. inż. Hanna Bogucka</h3>
                        <dl>
                             <dt><i class="fa fa-graduation-cap"></i> Konsultacje</dt>
                             <dd>Poniedziałek: 11:45-13:15</dd>
                             <dt><i class="fa fa-envelope-o"></i> E-mail</dt>
                             <dd>Hanna.Bogucka@put.poznan.pl</dd>
                             <dt><i class="fa fa-phone"></i> telefon</dt>
                             <dd>+ 48 61 6653911</dd>
                        </dl>
                     </div>
                     <div class="didactics-more"><i class="fa fa-folder-open-o"></i> Więcej informacji</div>
                    </div>
                </a>
                </div>
                ...
                <div class="col-block didactics-item" data-aos="fade-up">
                        ...
                        <div class="didactics-text">
                            <h3>Prof. dr hab. inż. Krzysztof Wesołowski</h3>
                            <dl>
                                 <dt><i class="fa fa-graduation-cap"></i> Konsultacje</dt>
                                 <dd>Wtorek: 11:45-13:15</dd>
                                 <dt><i class="fa fa-envelope-o"></i> E-mail</dt>
                                 <dd>Krzysztof.Wesolowski@put.poznan.pl</dd>
                                 <dt><i class="fa fa-phone"></i> telefon</dt>
                                 <dd>+ 48 61 6653812</dd>
                            </dl>
                        </div>
                    ...
                    <div class="col-block didactics-item" data-aos="fade-up">
                            ...
                            <div class="didactics-text">
                                <h3>Prof. dr hab. inż. Jerzy  Tyszer</h3>
                                <dl>
                                     <dt><i class="fa fa-graduation-cap"></i> Konsultacje</dt>
                                     <dd>Wtorek: 11:45-13:15</dd>
                                     <dt><i class="fa fa-envelope-o"></i> E-mail</dt>
                                     <dd>Jerzy.Tyszer@put.poznan.pl</dd>
                                     <dt><i class="fa fa-phone"></i> telefon</dt>
                                     <dd>+ 48 61 6653813</dd>
                                </dl>
                            </div>
                        ...
                        <div class="col-block didactics-item" data-aos="fade-up">
                                ...
                                <div class="didactics-text">
                                    <h3>dr hab. inż. Paweł Szulakiewicz</h3>
                                    <dl>
                                         <dt><i class="fa fa-graduation-cap"></i> Konsultacje</dt>
                                         <dd>Wtorek: 11:45-13:15</dd>
                                         <dt><i class="fa fa-envelope-o"></i> E-mail</dt>
                                         <dd>Pawel.Szulakiewicz@put.poznan.pl</dd>
                                         <dt><i class="fa fa-phone"></i> telefon</dt>
                                         <dd>+ 48 61 6653812</dd>
                                    </dl>
                                </div>
            ...
            </div> <!-- end didactics-list -->
    
     </section> <!-- end s-didactics -->
    ...
    <section id="contact" class="s-contact">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-2 display-2--light">Zapraszamy do kontaktu</h1>
            </div>
        </div>
        ...
        <div class="row contact-content" data-aos="fade-up">
            ...
            <div class="contact-primary">
                ...
                <h3 class="h6">Wyślij nam wiadomość</h3>

                <form name="contactForm" id="contactForm" method="post" action="" novalidate="novalidate">
                    <fieldset>
    
                    <div class="form-field">
                        <input name="contactName" type="text" id="contactName" placeholder="Imię i nazwisko" value="" minlength="2" required="" aria-required="true" class="full-width">
                    </div>
                    <div class="form-field">
                        <input name="contactEmail" type="email" id="contactEmail" placeholder="Twój adres Email" value="" required="" aria-required="true" class="full-width">
                    </div>
                    <div class="form-field">
                        <input name="contactSubject" type="text" id="contactSubject" placeholder="Temat wiadomości" value="" class="full-width">
                    </div>
                    <div class="form-field">
                        <textarea name="contactMessage" id="contactMessage" placeholder="Wiadomość" rows="10" cols="50" required="" aria-required="true" class="full-width"></textarea>
                    </div>
                    <div class="form-field">
                        <button class="full-width btn--primary">Wyślij</button>
                        <div class="submit-loader">
                            <div class="text-loader">Wysyłam...</div>
                            <div class="s-loader">
                ...
                <div class="message-success">
                    Wiadomośc została wysłana, dziekujemy!<br>
                </div>
            ...
            <div class="contact-secondary">
                <div class="contact-info">
                    ...
                    <h3 class="h6 hide-on-fullwidth">Informacje teleadresowe</h3>

                    <div class="cinfo">
                        <h5>Gdzie nas znaleźć</h5>
                        <p>
                            ul. Polanka 3<br>
                            60-965 Poznań, Polska<br>
                        </p>
                    </div>
    ...
    <footer>
        ...
        <div class="row footer-main">
            ...
            <div class="col-six tab-full left footer-desc">
                ...
                <h4>Katedra Radiokomunikacji</h4>
                <p>ul. Polanka 3<br />
                   60-965 Poznań, Polska</p>
                   <p>office_ctcn@put.poznan.pl<br />
                   Tel.: +48 61 665 39 11<br />
                   Fax: +48 61 665 38 23
                   </p>
            </div>
            ...
            <div class="col-six tab-full right footer-subscribe">
                ...
                <p>Wydział Elektroniki i Telekomunikacji</p>
            </div>
